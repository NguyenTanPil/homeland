...
import { getCurrentHouse } from '../../utils';

const PropertyDetails = () => {
	const { id } = useParams();
	const house = getCurrentHouse(id);
		...
		<section className='px-12'>
			<div className='container mx-auto min-h-[800px] mb-14'>
				...
				<div className='flex flex-col items-start gap-8 lg:flex-row'>
					<div className='max-w-[568px] xl:max-w-[768px]'>
						<div className='mb-8 '>
							<img
								src={house.imageLg}
								alt='house image'
					...
					<div className='flex-1 w-full mb-8 border bg-white border-gray-300 rounded-lg px-6 py-8'>
						<div className='flex items-center gap-x-4 mb-8'>
							<div className='w-20 h-20 min-w-20 p-1 border border-gray-300 rounded-full'>
								<img
						...
						<form className='flex flex-col gap-y-4'>
							...
							/>
							<textarea
								className='border border-gray-300 focus:border-violet-700 outline-none resize-none rounded w-full p-4 h-36 test-sm text-gray-400'
								placeholder='Message*'
								defaultValue='Hello I am interested in [Modern hotel]'
							/>
